...
Compilation options: -a supercollider.cpp -lang cpp -i -ct 1 -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a supercollider.cpp -lang cpp -i -ct 1 -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		iConst6 = std::min<int>(65536, std::max<int>(0, int(0.0046282047f * fConst0) + -1));
		iConst7 = std::min<int>(65536, std::max<int>(0, int(0.0037031686f * fConst0) + -1));
		iConst8 = std::min<int>(65536, std::max<int>(0, int(0.013116831f * fConst0) + -1));
		iConst9 = std::min<int>(65536, std::max<int>(0, int(0.009028259f * fConst0) + -1));
		iConst10 = std::min<int>(65536, std::max<int>(0, int(0.10628003f * fConst0))) + 1;
		fConst11 = 1.0f / fConst0;
		fConst12 = 1.0f / float(int(0.01f * fConst0));
		iConst13 = std::min<int>(65536, std::max<int>(0, int(0.14169551f * fConst0)));
		iConst14 = std::min<int>(65536, std::max<int>(0, int(0.08924431f * fConst0) + -1));
		iConst15 = std::min<int>(65536, std::max<int>(0, int(0.0049144854f * fConst0) + -1));
		iConst16 = std::min<int>(65536, std::max<int>(0, int(0.00348745f * fConst0) + -1));
		iConst17 = std::min<int>(65536, std::max<int>(0, int(0.012352743f * fConst0) + -1));
		iConst18 = std::min<int>(65536, std::max<int>(0, int(0.009586708f * fConst0) + -1));
		iConst19 = std::min<int>(65536, std::max<int>(0, int(0.1249958f * fConst0))) + 1;
		iConst20 = std::min<int>(65536, std::max<int>(0, int(0.14962535f * fConst0)));
		iConst21 = std::min<int>(65536, std::max<int>(0, int(0.06048184f * fConst0) + -1));
		iConst22 = std::min<int>(65536, std::max<int>(0, int(0.03581869f * fConst0)));
		iConst23 = std::min<int>(65536, std::max<int>(0, int(0.006283391f * fConst0)));
		iConst24 = std::min<int>(65536, std::max<int>(0, int(0.06686603f * fConst0)));
		iConst25 = std::min<int>(65536, std::max<int>(0, int(0.06427875f * fConst0)));
		iConst26 = std::min<int>(65536, std::max<int>(0, int(0.06706764f * fConst0)));
		iConst27 = std::min<int>(65536, std::max<int>(0, int(0.09992944f * fConst0)));
		iConst28 = std::min<int>(65536, std::max<int>(0, int(0.008937872f * fConst0)));
		iConst29 = std::min<int>(65536, std::max<int>(0, int(0.0040657236f * fConst0)));
		iConst30 = std::min<int>(65536, std::max<int>(0, int(0.011256342f * fConst0)));
		iConst31 = std::min<int>(65536, std::max<int>(0, int(0.070931755f * fConst0)));
		iConst32 = std::min<int>(65536, std::max<int>(0, int(0.041262053f * fConst0)));
		iConst33 = std::min<int>(65536, std::max<int>(0, int(0.08981553f * fConst0)));
		iConst34 = std::min<int>(65536, std::max<int>(0, int(0.121870905f * fConst0)));
		iConst35 = std::min<int>(65536, std::max<int>(0, int(0.01186116f * fConst0)));
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("Predelay", &fHslider7, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(3e+02f), FAUSTFLOAT(1.0f));
		ui_interface->declare(&fHslider6, "02", "");
		ui_interface->declare(&fHslider6, "symbol", "input");
		ui_interface->declare(&fHslider6, "unit", "%");
		ui_interface->addHorizontalSlider("Input amount", &fHslider6, FAUSTFLOAT(1e+02f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1e+02f), FAUSTFLOAT(0.01f));
		...
		ui_interface->addHorizontalSlider("Input low-pass cutoff", &fHslider5, FAUSTFLOAT(1e+04f), FAUSTFLOAT(1.0f), FAUSTFLOAT(2e+04f), FAUSTFLOAT(1.0f));
		...
		ui_interface->addHorizontalSlider("Input high-pass cutoff", &fHslider4, FAUSTFLOAT(1e+02f), FAUSTFLOAT(1.0f), FAUSTFLOAT(1e+03f), FAUSTFLOAT(1.0f));
		...
		ui_interface->addHorizontalSlider("Input diffusion 1", &fHslider3, FAUSTFLOAT(75.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1e+02f), FAUSTFLOAT(0.01f));
		...
		ui_interface->addHorizontalSlider("Input diffusion 2", &fHslider2, FAUSTFLOAT(62.5f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1e+02f), FAUSTFLOAT(0.01f));
		ui_interface->declare(&fHslider1, "07", "");
		ui_interface->declare(&fHslider1, "symbol", "tail_density");
		ui_interface->declare(&fHslider1, "unit", "%");
		ui_interface->addHorizontalSlider("Tail density", &fHslider1, FAUSTFLOAT(7e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1e+02f), FAUSTFLOAT(0.01f));
		ui_interface->declare(&fHslider8, "08", "");
		ui_interface->declare(&fHslider8, "symbol", "decay");
		ui_interface->declare(&fHslider8, "unit", "%");
		ui_interface->addHorizontalSlider("Decay", &fHslider8, FAUSTFLOAT(5e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1e+02f), FAUSTFLOAT(0.01f));
		ui_interface->declare(&fHslider0, "09", "");
		ui_interface->declare(&fHslider0, "scale", "log");
		ui_interface->declare(&fHslider0, "symbol", "damping");
		ui_interface->declare(&fHslider0, "unit", "Hz");
		ui_interface->addHorizontalSlider("Damping", &fHslider0, FAUSTFLOAT(5.5e+03f), FAUSTFLOAT(1e+01f), FAUSTFLOAT(2e+04f), FAUSTFLOAT(1.0f));
		...
		ui_interface->addHorizontalSlider("Modulator frequency", &fHslider9, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f), FAUSTFLOAT(4.0f), FAUSTFLOAT(0.01f));
		...
		ui_interface->addHorizontalSlider("Modulator depth", &fHslider10, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1e+01f), FAUSTFLOAT(0.1f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			int iTemp2 = std::min<int>(65536, std::max<int>(0, int(fConst0 * fRec28[0])));
			fRec26[0] = fVec0[(IOTA0 - iTemp2) & 131071] + fRec25[0] * fRec26[1];
			fRec23[0] = fRec26[0] * fTemp1 + fRec24[0] * fRec23[1];
			float fTemp3 = fRec24[0] + 1.0f;
			float fTemp4 = 0.5f * fTemp3 * (fRec23[0] - fRec23[1]) - fRec20[0] * fRec21[1];
			...
			float fTemp8 = fRec13[1] + fRec29[0] * fRec3[(IOTA0 - iConst10) & 32767] + fRec14 + fRec12[0] * fRec10[1];
			...
			int iTemp10 = int(fConst0 * (fRec37[0] * ftbl0mydspSIG0[std::max<int>(0, std::min<int>(int(65536.0f * (fRec35[0] + (0.25f - float(int(fRec35[0] + 0.25f))))), 65535))] + 0.030509727f)) + -1;
			float fTemp11 = ((fRec30[1] != 0.0f) ? (((fRec31[1] > 0.0f) & (fRec31[1] < 1.0f)) ? fRec30[1] : 0.0f) : (((fRec31[1] == 0.0f) & (iTemp10 != iRec32[1])) ? fConst12 : (((fRec31[1] == 1.0f) & (iTemp10 != iRec33[1])) ? -fConst12 : 0.0f)));
			fRec30[0] = fTemp11;
			fRec31[0] = std::max<float>(0.0f, std::min<float>(1.0f, fRec31[1] + fTemp11));
			iRec32[0] = (((fRec31[1] >= 1.0f) & (iRec33[1] != iTemp10)) ? iTemp10 : iRec32[1]);
			iRec33[0] = (((fRec31[1] <= 0.0f) & (iRec32[1] != iTemp10)) ? iTemp10 : iRec33[1]);
			float fTemp12 = fVec5[(IOTA0 - std::min<int>(65536, std::max<int>(0, iRec32[0]))) & 131071];
			fRec10[0] = fTemp12 + fRec31[0] * (fVec5[(IOTA0 - std::min<int>(65536, std::max<int>(0, iRec33[0]))) & 131071] - fTemp12);
			...
			float fTemp14 = std::min<float>(0.5f, std::max<float>(0.25f, fRec29[0] + 0.15f));
			...
			float fTemp16 = 0.5f * fTemp3 * (fRec51[0] - fRec51[1]) - fRec20[0] * fRec49[1];
			...
			float fTemp20 = fRec43[1] + fRec29[0] * fRec0[(IOTA0 - iConst19) & 32767] + fRec44 + fRec12[0] * fRec41[1];
			fVec14[IOTA0 & 131071] = fTemp20;
			int iTemp21 = int(fConst0 * (fRec37[0] * ftbl0mydspSIG0[std::max<int>(0, std::min<int>(int(65536.0f * fRec35[0]), 65535))] + 0.025603978f)) + -1;
			float fTemp22 = ((fRec53[1] != 0.0f) ? (((fRec54[1] > 0.0f) & (fRec54[1] < 1.0f)) ? fRec53[1] : 0.0f) : (((fRec54[1] == 0.0f) & (iTemp21 != iRec55[1])) ? fConst12 : (((fRec54[1] == 1.0f) & (iTemp21 != iRec56[1])) ? -fConst12 : 0.0f)));
			fRec53[0] = fTemp22;
			fRec54[0] = std::max<float>(0.0f, std::min<float>(1.0f, fRec54[1] + fTemp22));
			iRec55[0] = (((fRec54[1] >= 1.0f) & (iRec56[1] != iTemp21)) ? iTemp21 : iRec55[1]);
			iRec56[0] = (((fRec54[1] <= 0.0f) & (iRec55[1] != iTemp21)) ? iTemp21 : iRec56[1]);
			float fTemp23 = fVec14[(IOTA0 - std::min<int>(65536, std::max<int>(0, iRec55[0]))) & 131071];
			fRec41[0] = fTemp23 + fRec54[0] * (fVec14[(IOTA0 - std::min<int>(65536, std::max<int>(0, iRec56[0]))) & 131071] - fTemp23);
			...
			output0[i0] = FAUSTFLOAT(0.6f * (fRec2[(IOTA0 - iConst28) & 32767] + fRec2[(IOTA0 - iConst27) & 32767] + fRec0[(IOTA0 - iConst26) & 32767] - (fRec1[(IOTA0 - iConst25) & 16383] + fRec5[(IOTA0 - iConst24) & 32767] + fRec4[(IOTA0 - iConst23) & 8191] + fRec3[(IOTA0 - iConst22) & 32767])));
			output1[i0] = FAUSTFLOAT(0.6f * (fRec5[(IOTA0 - iConst35) & 32767] + fRec5[(IOTA0 - iConst34) & 32767] + fRec3[(IOTA0 - iConst33) & 32767] - (fRec4[(IOTA0 - iConst32) & 8191] + fRec2[(IOTA0 - iConst31) & 32767] + fRec1[(IOTA0 - iConst30) & 16383] + fRec0[(IOTA0 - iConst29) & 32767])));
			fRec8[1] = fRec8[0];
			fRec12[1] = fRec12[0];
			fRec15[1] = fRec15[0];
			fRec20[1] = fRec20[0];
